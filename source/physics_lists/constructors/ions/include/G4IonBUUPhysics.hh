...
// ********************************************************************
//
// $Id: G4IonBUUPhysics.hh 78602 2014-01-09 11:40:04Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4IonBUUBuilder
//
...
#ifndef G4IonBUUPhysics_h
#define G4IonBUUPhysics_h 1
...
class G4IonBUUPhysics : public G4VPhysicsConstructor
{
public:
  G4IonBUUPhysics(G4int ver = 0);
  G4IonBUUPhysics(const G4String& name, G4int ver = 0);
  virtual ~G4IonBUUPhysics();
...
private:
  ...
  static G4ThreadLocal G4BUU* theBUUDeuteron;
  static G4ThreadLocal G4BUU* theBUUTriton;
  static G4ThreadLocal G4BUU* theBUUHe3;
  static G4ThreadLocal G4BUU* theBUUAlpha;
  static G4ThreadLocal G4BUU* theBUUIons;
